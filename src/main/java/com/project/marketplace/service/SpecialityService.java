...
//        this.initDB();
    ...
    private void initDB() {
        ...
        this.specialityRepositor.save(new Speciality("Immunologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        ...
        this.specialityRepositor.save(new Speciality("cardiologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie cardiaque",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie plastique ",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie générale",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie maxillo-faciale",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie pédiatrique",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie thoracique",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("chirurgie vasculaire",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("neurochirurgie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("dermatologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        ...
        this.specialityRepositor.save(new Speciality("médecine générale",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("médecine interne",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("médecine nucléaire",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("médecine palliative",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("médecine physique",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        ...
        this.specialityRepositor.save(new Speciality("neurologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        ...
        this.specialityRepositor.save(new Speciality("ophtalmologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        ...
        this.specialityRepositor.save(new Speciality("pneumologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("psychiatrie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("radiologie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
        this.specialityRepositor.save(new Speciality("radiothérapie",500,"http://localhost:8080/images/Specialities/img1.jpeg"));
